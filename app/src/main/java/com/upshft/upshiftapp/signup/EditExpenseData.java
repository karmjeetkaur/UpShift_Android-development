...
/**
 * Created by new on 4/25/2017.
 */

public class EditExpenseData extends AppCompatActivity
{
    private FirebaseAuth mFirebaseAuth;
    private FirebaseUser mFirebaseUser;
    private DatabaseReference mDatabase;
    private String mUserId;
    String category, amount, desc, date_str, club_key;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.edit_expenses);
        ...
        ed_platform_name.setText(category);
        ...
        editButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                setMatch(category, club_key);
            }
        });

    }

    public void setMatch(String category, final String clue_key) {

        mDatabase.child("ExpenseRecord")
                .child(mUserId)
                .child("items")
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot)
                    {
                        for (DataSnapshot childSnapshot : dataSnapshot.getChildren()) {
                            ...
                            if (clue_key.equals(clueKey)) {
                                ExpenseRecord newPost = childSnapshot.getValue(ExpenseRecord.class);
                                long startDate_val = newPost.getDate_time();
                                String amnt = newPost.getTotal_amount();
                                String desc = newPost.getDescription();
                                ...
                                Log.e("clubkey", "===========" + startDate_val + "====" + amnt + "====" + desc + "===========platform============" + category);
                                ExpenseRecord addListDataModal = new ExpenseRecord(timeInMilliseconds, ed_platform_name.getText().toString(),
                                        ed_amount.getText().toString(), ed_tip.getText().toString());
                                mDatabase.child("ExpenseRecord").child(mUserId).child("items").child(clueKey).setValue(addListDataModal);
                                onBackPressed();
